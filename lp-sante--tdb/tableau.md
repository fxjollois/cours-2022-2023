...
Dans cette présentation de l'outil, nous allons utiliser les données synthétiques de la production scientifique mondiale depuis 1996 ([lien vers le fichier Excel](https://fxjollois.github.io/donnees/scimagojr/scimagojr.xlsx) - source : [SCImago Journal & Country Rank](http://www.scimagojr.com/help.php))
