...
```{r creation-fichier, include=FALSE, eval=FALSE}
library(readr)
library(writexl)

url = "https://archive.ics.uci.edu/ml/machine-learning-databases/adult/adult.data"
adult = read_csv(url, col_names = FALSE)
adult2 = adult[sample(1:nrow(adult), 1000), c(1, 4, 10, 13, 15)]
colnames(adult2) = c("Age", "Etudes", "Sexe", "Heures", "Salaire")
adult2$Salaire = factor(adult2$Salaire, labels = c("Less than 50K", "More than 50K"))
write_xlsx(adult2, "base-tp1.xlsx")
```
...
- Pour `K8`, on écrit `LOI.NORMALE.INVERSE.N(1-K7/2/100; 0; 1)` (idem pour `L8` avec `L7` au lieu de `K8`)
