...
Supposons que nous avons un ensemble de 2000 prospects, et on suppose qu'on a en général un taux de conversion de 20%.

1. Que puis-je dire de la variable aléatoire modélisant le nombre de clients, après une campagne auprès de ces prospects ?
1. Suite à cette campagne, nous avons réussi à avoir au final 500 clients. Peut-on dire qu'on a bien été performant ?
1. Supposons maintenant que nous avons 3 produits différents à vendre à ces prospects, le taux de conversion est supposé le même entre les 3. 
  - Quelle est la probabilité qu'une personne achète les 3 produits ? Seulement 2 ? Seulement 1 ? Aucun ?
  - Comment puis-je modéliser le résultat de la campagne marketing sur ces 3 produits ?

<!--
Supposons un enseignant de statistiques $\mathbf{J}$ ayant un groupe de rock[[*]](https://sites.google.com/view/rusthead) et se produit à un concert $\mathbf{C}$ dans un bar à Cherbourg. On considère qu'un.e étudiant.e $\mathbf{E}$ a une probabilité de sortir le soir égale à $.5$, et a une probabilité de $.5$ d'aller dans le bar où se produit le groupe.
...
1. Maintenant, on se demande combien d'étudiants parmi les 80 de la promo viendront à un concert. Comment modéliser ce processus ? Quelle est la probabilité qu'au moins 10 étudiants viennent ?
1. Enfin, l'enseignant se produit au final 3 fois. On cherche donc à savoir quelle est la probabilité qu'un étudiant $\mathbf{E}$ voient les trois concerts $\mathbf{C1}$, $\mathbf{C2}$ et $\mathbf{C3}$. Comment puis-je faire ?
