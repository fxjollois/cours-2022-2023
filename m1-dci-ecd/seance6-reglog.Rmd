...
- Rôle pas forcément symétrique (entre taille et poids, par exemple)
  ...
  - Le poids est fonction de l'ége (et non l'inverse)

- Quelle est la relation de dépendance de $Y$ par rapport é $X$ ?
...
table(m$fitted.values > 0.5, adult$class)
```
...
---
### Courbe de \emph{performance}

- Taux de vrai positifs vs Taux de pr?dictions positives
- Pour 40 \% des positifs pr?dits, on 89 \% des positifs
